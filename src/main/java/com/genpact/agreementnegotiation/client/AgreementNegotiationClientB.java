 ...
 */
public class AgreementNegotiationClientB {
    private static final Logger logger = LoggerFactory.getLogger(AgreementNegotiationClientB.class);
    ...
    public static void main(String[] args) throws ActiveMQException, InterruptedException, ExecutionException {
        ...
        snapshot.getStates().forEach(AgreementNegotiationClientB::logState);
        updates.toBlocking().subscribe(update -> update.getProduced().forEach(AgreementNegotiationClientB::logState));
    }
}